var ModalDadosDaeController = function ($uibModalInstance, mensagem, caracterizacao, caracterizacaoService) {
	...
	caracterizacaoService.dadosDae(modalCtrl.idCaracterizacao).then(function (response) {
...
exports.controllers.ModalDadosDaeController = ModalDadosDaeController;
