...
public class QJUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(QJUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new QJUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static QJUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static QJUDateTimeConverter dateTimeConverter = new QJUStandardDateTimeConverter();

    public QJUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public QJUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new QJUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!= String.class  )) {
                String xmlName=QJUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,QJUExtendedSoapSerializationEnvelope.class);
    ...
    public static Object getXSDType(Object param)
    {
        ...
        String xmlName=QJUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
