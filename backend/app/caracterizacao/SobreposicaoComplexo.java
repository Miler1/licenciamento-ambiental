...
public class SobreposicaoComplexo extends GenericModel  implements SobreposicaoDistancia {
    ...
    public SobreposicaoComplexo(TipoSobreposicao tipoSobreposicao, Caracterizacao caracterizacao, DadosSobreposicaoVO dadosSobreposicao) {
